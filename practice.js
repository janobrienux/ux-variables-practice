...
let message = "I will need " + totalBagsofChips  +  " to last me until the ripe old age of " + maxAge;
...
message = "I will be either 38 or 39.";
...
tempConverted = tempInFarenheit - 32 * 5/9;
console.log(tempConverted);

// 6. Output to console.log() in the format "NN°F is NN°C."
console.log(tempInFarenheit + " is " + tempInCelcius);
